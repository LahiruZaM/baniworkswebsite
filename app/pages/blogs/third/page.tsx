            ...
            <main className="container mx-auto py-10 px-4">
                <article className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="text-black space-y-6">
                        ...
                        <h2 className="text-2xl font-semibold">1. Understand Your Target Audience</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">2. Select Your Best Work</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">3. Craft Case Studies</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">4. Organize and Present Your Work Effectively</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">5. Incorporate Visual Elements</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">6. Highlight Your Skills and Services</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">7. Optimize for Different Platforms</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold">8. Update Regularly</h2>
                        <p>
