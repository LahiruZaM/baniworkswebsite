            ...
            <div className="container mx-auto py-10 px-4">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="text-black space-y-6">
                        ...
                        <h2 className="font-semibold">Setting Clear and Achievable Goals</h2>
                        <p>
                        ...
                        <h2 className="font-semibold">Creating a Structured Schedule</h2>
                        <p>
                        ...
                        <h2 className="font-semibold">Leveraging Technology</h2>
                        <p>
                        ...
                        <h2 className="font-semibold">Learning to Say No</h2>
                        <p>
                        ...
                        <h2 className="font-semibold">Regular Evaluation</h2>
                        <p>
